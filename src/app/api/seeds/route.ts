...
function sampleSeeds(lang: "en" | "ko"): SeedSuggestion[] {
  const en: SeedSuggestion[] = [
    { angle: "The daily grind", nudge: "What part of this do you deal with directly that others might not see?" },
    { angle: "What people feel", nudge: "Who is affected by this, and what do they complain about most?" },
    { angle: "The trade-off", nudge: "What are you being forced to give up to get something else here?" },
    { angle: "What's fragile", nudge: "What's shaky under the surface that could break if this changes?" },
    { angle: "The quiet worry", nudge: "What are you privately worried about that no one has said out loud?" },
  ];
  const ko: SeedSuggestion[] = [
    { angle: "매일의 현장", nudge: "이 문제에서 당신이 직접 부딪히는, 남들은 못 보는 부분은?" },
    { angle: "사람들이 느끼는 것", nudge: "누가 영향을 받고, 그들이 가장 자주 불평하는 건 무엇인가요?" },
    { angle: "트레이드오프", nudge: "여기서 무언가를 얻기 위해 포기하도록 강요받는 것은?" },
    { angle: "취약한 지점", nudge: "표면 아래에서 흔들리는, 바뀌면 깨질 수 있는 건?" },
    { angle: "조용한 걱정", nudge: "아무도 소리 내어 말하지 않았지만 당신이 조용히 걱정하는 건?" },
  ];
